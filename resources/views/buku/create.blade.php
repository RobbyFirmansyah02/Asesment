                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('buku.store') }}" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Email Address <small class="text-danger">*</small></label>
                                                <input type="text" name="penulis" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                            <div class="mb-3">
                                                <label for="formFile " class="form-label">Foto Profil <small class="text-danger">*</small></label>
